...
describe('Basic Tests', () => {
    ...
    it("should parse specific test cases", () => {
        const cases = [
            ...
            { "case": "/mark/5", "solution": { book: "Mark", chapter: 5, verse: null } },
            { "case": "/Chronica_I/28", "solution": { book: "1 Chronicles", chapter: 28, verse: null } },
            ...
            { "case": "Pol. Phil. 15", "solution": { book: "Polycarp to the Philippians", chapter: 15, verse: null } },
        ]
        cases.forEach(c => {
